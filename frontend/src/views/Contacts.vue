    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
      ...
      <div class="lg:col-span-5 space-y-3.5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3">
          <a :href="'tel:' + (contactData.phone || '+79117775700')"
            ...
            <div
              class="w-12 h-12 rounded-xl bg-gray-900 dark:bg-white text-white dark:text-gray-900 flex items-center justify-center group-hover:scale-105 transition-transform shadow-sm shrink-0">
          ...
          <!-- Official VK Card -->
          <a :href="contactData.vk || 'https://vk.com/lesnikovfoto'" target="_blank"
            ...
            <div
              class="w-12 h-12 rounded-xl bg-[#0077FF] text-white flex items-center justify-center group-hover:scale-105 transition-transform shadow-sm shrink-0">
        ...
        <!-- Location Card -->
        <div
          class="liquid-card p-4 sm:p-5 rounded-2xl flex items-center gap-4 shadow-sm border border-white/60 dark:border-white/10">
          <div
            class="w-12 h-12 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-700 dark:text-slate-300 shrink-0">
        ...
        <div
          ...
          <div>
            ...
            <a :href="'mailto:' + (contactData.email || 'lesnikovfoto@mail.ru')"
      ...
      <!-- Lead Form -->
      <div
        class="lg:col-span-7 liquid-card p-6 sm:p-10 rounded-3xl shadow-xl border border-white/60 dark:border-white/10">
        ...
        <form @submit.prevent="submit" class="space-y-4">
          <div>
            ...
            <input v-model="form.name" required type="text" placeholder="Как к вам обращаться"
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input v-model="form.phone" required type="tel" placeholder="+7 (___) ___-__-__"
          ...
          <div>
            ...
            <textarea v-model="form.message" rows="3"
              ...
              class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white/60 dark:bg-black/30 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-white transition-all text-sm resize-none"></textarea>
          </div>
